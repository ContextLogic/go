...
// Following two helper functions are taken directly from encoding/base64 stdlib
...
func (codec *base64Codec) Decode(ptr unsafe.Pointer, iter *Iterator) {
	...
	case StringValue:
		...
		// Logic taken from encoding/base64 of the stdlib
		src, ok := unquoteBytes(src)
		if !ok {
			panic("Failed to unquoteBytes, data may have changed underfoot?")
		}
